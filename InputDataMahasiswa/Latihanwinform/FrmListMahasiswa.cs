...
namespace Latihanwinform
{
    public partial class FrmListMahasiswa : Form
    {
        ...
        private void InisialisasiListView()
        {
            ...
            lvwMahasiswa.Columns.Add("NIM", 100, HorizontalAlignment.Left);
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            if (!mskNpm.MaskFull)
            {
                MessageBox.Show("NIM Harus Diisi!", "WARNING", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                mskNpm.Focus();
                return;
            }
            ...
            {
                MessageBox.Show("Nama Harus Diisi!", "WARNING", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtNama.Focus();
                return;
            }
