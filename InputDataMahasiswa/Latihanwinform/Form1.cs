...
namespace Latihanwinform
{
    public partial class Form1 : Form
    {
        ...
        private void btnTampil_Click(object sender, EventArgs e)
        {
            if  (!mskNPM.MaskFull)
            {
                MessageBox.Show("NIM wajib diisi!", "WARNING", MessageBoxButtons.OK,
            ...
            {
                MessageBox.Show("Nama wajib diisi!", "WARNING", MessageBoxButtons.OK,
                    MessageBoxIcon.Exclamation);
                txtNama.Focus();
                return;
            }
            ...
            {
                MessageBox.Show("Tempat Lahir diisi!!!", "WARNING", MessageBoxButtons.OK,
                    MessageBoxIcon.Exclamation);
